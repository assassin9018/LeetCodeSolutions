...
internal class S1470(IReadHelper reader, IWriteHelper<int> writer) : EnumerableResultSolution<int>(reader, writer)
{
    ...
    public override string Description => @"Given the array nums consisting of 2n elements in the form [x1,x2,...,xn,y1,y2,...,yn].
